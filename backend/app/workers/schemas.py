...
class FTCMatch(BaseModel):
    matchNumber: int = 0
    series: int = 1
    tournamentLevel: Optional[str] = None
    scoreRedFinal: Optional[int] = None
    scoreBlueFinal: Optional[int] = None
    scoreTotalRed: Optional[int] = None
    scoreTotalBlue: Optional[int] = None
    actualStartTime: Optional[str] = None
    startTime: Optional[str] = None
    teams: list[FRCMatchTeam] = []  # same shape
